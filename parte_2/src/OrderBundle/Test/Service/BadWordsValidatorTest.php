...
class BadWordsValidatorTest extends TestCase
{
    ...
    public function hasBadWords($badWordsList, $text, $foundBadWords)
    {
        ...
        //STUBS é quando a gente cria um objeto falso semelhante ao real para poder testar uma classe com dependencia
        //faz a carga da classe para poder ser testada
